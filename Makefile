test: build
	time ./randomForest -t ./data/H1hesc_allforward_features.txt -p 4 -n 100 -f 7 -g 0.001
...
valgrind: debug
	valgrind --leak-check=full ./randomForest -t ./data/H1hesc_train.txt -c ./data/H1hesc_test.txt -p 4 -n 4 -g 0.001
